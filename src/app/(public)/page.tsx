...
export default async function HomePage() {
  const [featured, services, team, testimonials, faqs] = await Promise.all([
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 lg:grid-cols-2">
          <div>
            ...
            <p className="text-muted-foreground mt-4 text-lg text-pretty">
              Cosmetic dentistry, implants, orthodontics and emergency treatment — delivered by a
              team that treats every patient like family.
            </p>
          ...
          <div className="bg-card rounded-2xl border p-6 shadow-sm">
            <p className="text-muted-foreground text-sm">This site is running on the SmileOn CMS.</p>
            <p className="mt-2 text-sm">
              Everything here — treatments, team, testimonials, FAQs and page content — is edited at{" "}
